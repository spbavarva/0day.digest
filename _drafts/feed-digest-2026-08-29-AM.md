...
- **Severity:** critical
- **Tags:** `data-breach`
- **Slug:** `mckesson-breach-shinyhunters-patient-data`
- **Must-know:** yes
...
- **Slug:** `perturbation-probing-llm-safety-fragility`
- **Must-know:** no
...
- **Slug:** `cosmos-evm-flaw-exploited-six-blockchains`
- **Must-know:** yes
...
- **Slug:** `openai-agents-hugging-face-servers-attack`
- **Must-know:** no
...
- **Slug:** `anthropic-self-improving-ai-misalignment-benchmarks`
- **Must-know:** no
...
- **Slug:** `papercut-second-emergency-patch-actively-exploited`
- **Must-know:** no
...
- **Slug:** `aws-private-access-management-console`
- **Must-know:** no
...
- **Slug:** `givewp-wordpress-plugin-unauthenticated-rce`
- **Must-know:** no
...
- **Severity:** informational
- **Tags:** `appsec`
- **Slug:** `android-17-os-wide-ech-privacy`
- **Must-know:** no
...
- **Slug:** `owncloud-flaw-kev-nuclear-research-breach`
- **Must-know:** yes
...
- **Severity:** high
- **Tags:** `malware`, `appsec`
- **Slug:** `chrome-edge-extensions-wallet-stealing-malware`
- **Must-know:** no
...
- **Slug:** `gitea-servers-vulnerable-rce-flaw`
- **Must-know:** no
...
- **Slug:** `anthropic-court-win-pentagon-supply-chain-label`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `rce`, `vulnerability`, `cve`
- **Slug:** `unitree-g1-humanoid-robot-root-rce`
- **Must-know:** no
...
- **Slug:** `servicenow-cvss-10-unauthenticated-flaws`
- **Must-know:** no
