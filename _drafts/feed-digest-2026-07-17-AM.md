...
- **Slug:** `sharepoint-cve-2026-58644-kev`
- **Must-know:** yes
...
- **Slug:** `fortinet-fortisandbox-cisa-patch`
- **Must-know:** no
- **Summary:** CISA ordered federal agencies to patch two actively exploited vulnerabilities in Fortinet's FortiSandbox threat detection platform by Sunday. The advisory summary did not include CVE identifiers or technical attack detail.
...
- **Slug:** `claude-chrome-extension-flaw`
- **Must-know:** no
...
- **Severity:** medium
- **Tags:** `phishing`, `llm`
- **Slug:** `hidden-text-phishing-ai-filters`
- **Must-know:** no
...
- **Slug:** `kimi-k3-moonshot-ai-model-launch`
- **Must-know:** no
