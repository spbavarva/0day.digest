...
- **Slug:** `2026-04-23-checkmarx-supply-chain-bitwarden-kics`
- **Must-know:** yes
- **Summary:** The `@bitwarden/cli@2026.4.0` npm package was compromised with malicious code in `bw1.js` that harvests credentials from developer environments. The same Checkmarx supply chain campaign also backdoored Docker images and VSCode/Open VSX extensions for the KICS infrastructure-as-code analysis tool.
...
- **Slug:** `2026-04-23-gopherwhisper-apt-mongolian-government`
- **Must-know:** no
...
- **Slug:** `2026-04-23-uat-4356-firestarter-cisco-firepower`
- **Must-know:** no
...
- **Slug:** `2026-04-23-anthropic-ai-agent-memory-vulnerability`
- **Must-know:** no
...
- **Slug:** `2026-04-23-uk-biobank-medical-data-breach`
- **Must-know:** no
...
- **Slug:** `2026-04-23-china-nexus-proxy-botnet-cisa-advisory`
- **Must-know:** no
...
- **Slug:** `2026-04-23-vercel-breach-expansion-contextai`
- **Must-know:** no
...
- **Slug:** `2026-04-23-openai-gpt-5-5-launch`
- **Must-know:** no
- **Summary:** OpenAI released GPT-5.5, described as its "smartest and most intuitive" model to date, excelling at coding, research, and data analysis across tools. GPT-5.5 follows GPT-5.4 from last month; the improved code reasoning capability is relevant to AI-assisted vulnerability analysis workflows for both defenders and adversaries.
...
- **Slug:** `2026-04-23-project-glasswing-anthropic-ai-bug-discovery`
- **Must-know:** no
...
- **Severity:** medium
- **Tags:** `data-breach`
- **Slug:** `2026-04-23-rituals-data-breach`
- **Must-know:** no
- **Summary:** Dutch cosmetics giant Rituals disclosed that attackers exfiltrated personal data — names and addresses — from its "My Rituals" membership database; the number of affected customers has not been disclosed but the loyalty program has millions of members. No technical attack vector was disclosed.
...
- **Slug:** `2026-04-23-delve-compliance-startup-ai-security-breach`
- **Must-know:** no
- **Summary:** TechCrunch confirmed that Delve, an AI compliance certification startup, was the compliance vendor for Context AI — the AI agent training company that disclosed a breach last week — making this at least the second Delve customer to experience a significant security incident. The pattern raises questions about third-party AI compliance vendors as a risk vector.
...
- **Tags:** `cisa`
- **Slug:** `2026-04-23-cisa-director-nominee-withdraws`
- **Must-know:** no
...
- **Slug:** `2026-04-23-trailmark-trail-of-bits-code-graph-ai`
- **Must-know:** no
...
- **Chinese APT Abuses Multiple Cloud Tools to Spy on Mongolia** — Dark Reading. Duplicate of GopherWhisper story; The Hacker News chosen as primary source.
- **It pays to be a forever student** — Cisco Talos. Newsletter opinion piece about interdisciplinary learning; no security news value.
...
- **China-linked hackers targeted Mongolian government using Slack, Discord** — The Record. Duplicate of GopherWhisper; THN chosen as primary source.
...
- **Regular Password Resets Aren't as Safe as You Think** — BleepingComputer. Sponsored Specops Software content; marketing disguised as news.
- **Grab a ticket today: The first StrictlyVC of 2026** — TechCrunch AI. Event promotion, no news value.
- **THE PEOPLE DO NOT YEARN FOR AUTOMATION** — The Verge AI. Opinion podcast with no breaking news.
...
- **Carlson Software VASCO-B GNSS Receiver (CVE-2026-3893, CVSS 9.4)** — CISA Alerts. ICS advisory for niche surveying equipment; very narrow deployment.
- **Hangzhou Xiongmai Technology XM530 IP Camera (CVE-2025-65856, CVSS 9.8)** — CISA Alerts. Routine IoT authentication advisory; no widespread active exploitation reported.
- **Yadea T5 Electric Bicycle (CVE-2025-70994)** — CISA Alerts. Transportation IoT; vehicle theft scope too narrow for practitioner action.
...
- **AI Can Autonomously Hack Cloud Systems With Minimal Oversight: Researchers** — SecurityWeek. Duplicate of Zealot research; Unit 42 primary source chosen.
...
- **Apple Patches iOS Flaw Allowing Recovery of Deleted Chats** — SecurityWeek. Duplicate; core story already covered in `2026-04-22-apple-ios-notification-data-retention.md`.
