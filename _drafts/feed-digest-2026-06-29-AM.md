...
- **Slug:** `libssh2-cve-2026-55200-poc`
- **Must-know:** no
- **Summary:** A public PoC is now available for CVE-2026-55200, a CVSS 9.2 memory corruption flaw in libssh2 that lets a malicious SSH server compromise a connecting client with no auth or user interaction. Affects all releases up to 1.11.1; no confirmed active exploitation yet.
...
- **Slug:** `hijacked-npm-go-packages-infostealer`
- **Must-know:** no
- **Summary:** JFrog found two hijacked npm packages and a cluster of Go packages deploying a Python infostealer via VS Code task configs, sidestepping npm lifecycle-script hardening. Cross-ecosystem (npm + Go) supply chain attack affecting Windows, Linux, and macOS.
...
- **Slug:** `microsoft-removes-edge-extensions-stegoad-malware`
- **Must-know:** no
...
- **Slug:** `dirtyclone-linux-kernel-privilege-escalation`
- **Must-know:** no
...
- **Slug:** `gentlemen-raas-custom-backdoors`
- **Must-know:** no
...
- **Slug:** `gamaredon-ukraine-cloud-service-abuse`
- **Must-know:** no
- **Summary:** ESET tracked 35 new Gamaredon spear-phishing campaigns against Ukraine through 2025, plus new malware and cloud-service abuse for C2/exfiltration. Targets remain Ukrainian government and military.
...
- **Slug:** `openai-anthropic-limit-ai-models-trump-approved-customers`
- **Must-know:** no
...
- **Slug:** `us-bounty-russian-state-hackers-messaging-apps`
- **Must-know:** no
- **Summary:** The US is offering $10M for info on UNC5792/UNC4221, Russian state hackers targeting US officials and military via messaging app attacks, as part of continued efforts to disrupt Russian state-backed operations.
...
- **Slug:** `openai-gpt-5-6-sol-cybersecurity-ai`
- **Must-know:** no
