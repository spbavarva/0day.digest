...
- **Slug:** `prompt-injection-ai-agents-crypto-payments`
- **Must-know:** no
...
- **Slug:** `device-code-phishing-microsoft`
- **Must-know:** no
...
- **Slug:** `trojpix-air-gap-video-cable-exfiltration`
- **Must-know:** no
...
- **Severity:** medium
- **Tags:** `malware`, `rce`
- **Slug:** `quimarat-java-cross-platform-rat`
- **Must-know:** no
...
- **Slug:** `opera-gx-flaw-auto-install-malicious-mods`
- **Must-know:** no
...
- **Slug:** `skillcloak-ai-agent-skill-evasion`
- **Must-know:** no
