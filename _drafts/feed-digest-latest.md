...
- **Organizations Warned of Exploited Windows, Adobe Acrobat Vulnerabilities** — SecurityWeek. Duplicate coverage — the CISA KEV item (item 11) covers the same exploited Windows and Adobe CVEs with broader scope.
