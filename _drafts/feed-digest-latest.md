...
- **Summary:** AI agents (Kimi K3) found zero-day memory flaws in Redis and built authenticated RCE PoCs across four version lines; Redis shipped seven patches on July 23. Responsibly disclosed rather than actively exploited in the wild.
