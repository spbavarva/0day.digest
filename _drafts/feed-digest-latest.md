...
- **Summary:** Microsoft patched CVE-2026-42897, an Exchange Server vulnerability it warned was being exploited as a zero-day on May 14. On-prem Exchange admins should patch immediately and check logs for prior compromise.
...
- **Summary:** Both vendors patched severe flaws that could let attackers create/modify arbitrary files and access or modify protected resources. No active exploitation reported yet.
