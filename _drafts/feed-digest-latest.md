...
- **Summary:** Dragos documented an intrusion at a Mexican water utility where threat actors used Claude AI to guide movement toward OT assets. First documented case of AI being weaponized against critical infrastructure OT networks.
...
- **Severity:** high
- **Tags:** `data-breach`
- **Summary:** ShinyHunters attacked Instructure, operator of Canvas LMS deployed across thousands of universities and school districts. Full scope of data exfiltration has not been disclosed; highlights concentration risk in educational vendor platforms.
...
- **Five architects of the AI economy explain where the wheels are coming off** — TechCrunch AI. Conference panel discussion; opinion with no news value.
- **Musk's biggest loyalist became his biggest liability** — The Verge AI. Courtroom gossip from Musk v. Altman trial; no technical content.
...
- **Is xAI a neocloud now?** — TechCrunch AI. Business analysis; no security angle.
- **Google shuts down Project Mariner** — The Verge AI. AI product shutdown; no security implications.
- **Palo Alto warns of critical software bug used in firewall attacks** — The Record. Duplicate coverage of CVE-2026-0300; Unit 42 threat brief is the primary source.
- **How David Sacks crashed and burned in the White House** — The Verge AI. Political opinion newsletter; no technical content.
- **New compliance guide available: ISO/IEC 42001:2023 on AWS** — AWS Security Blog. Compliance documentation release; no news value.
