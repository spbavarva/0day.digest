...
### 9. Eurail Confirms Over 300,000 Passport Numbers Exposed in December Breach
...
- **Must-know:** no
- **Summary:** HackerOne paused bug bounty payouts for open source projects after AI-driven discovery tooling shifted the bottleneck from finding bugs to fixing them—a cost that bounties don't fund. This marks a structural inflection point for the vulnerability disclosure ecosystem driven by AI tooling.
