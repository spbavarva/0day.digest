...
- **Slug:** `simplehelp-oidc-rogue-technician-accounts`
- **Must-know:** no
...
- **Slug:** `north-korea-developer-recruitment-malware-contagious-interview`
- **Must-know:** no
...
- **Slug:** `cisco-sdwan-vmanage-zero-day-root-privilege-escalation`
- **Must-know:** yes
...
- **Slug:** `litellm-vulnerability-chain-ai-gateway-takeover`
- **Must-know:** no
...
- **Slug:** `cybersecurity-experts-protest-anthropic-fable-mythos-export-ban`
- **Must-know:** no
...
- **Slug:** `m365-copilot-searchleak-one-click-data-exfiltration`
- **Must-know:** no
...
- **Slug:** `china-nexus-redcap-infinitered-malware-medical-research`
- **Must-know:** no
