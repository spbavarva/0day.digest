...
- **Slug:** `2026-05-17-nginx-cve-2026-42945-rce-active-exploitation`
- **Must-know:** yes
- **Summary:** A heap buffer overflow (CVSS 9.2) in NGINX's ngx_http_rewrite_module is actively exploited in the wild days after public disclosure, affecting versions 0.6.27–1.30.0. Exploitation can crash worker processes and enable RCE across a massive segment of global web infrastructure.
...
- **Slug:** `2026-05-17-grafana-github-token-breach-codebase-extortion`
- **Must-know:** yes
...
- **Slug:** `2026-05-17-tycoon2fa-device-code-phishing-microsoft-365`
- **Must-know:** no
...
- **Slug:** `2026-05-17-nhs-open-source-retreat-gds-vulnerability-response`
- **Must-know:** no
- **Summary:** The UK NHS closed public access to its open source repositories after vulnerability reports via Project Glasswing, prompting criticism of security-through-obscurity. The UK GDS has now weighed in recommending open-by-default policies, surfacing a broader tension between disclosure and open source transparency in the public sector.

## Skippable

- **University of Arizona students boo Eric Schmidt's AI cheerleading during commencement** — The Verge AI. Social commentary on student reaction to AI optimism at a graduation ceremony; no security or technical angle.
