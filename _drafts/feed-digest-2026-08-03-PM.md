...
- **Slug:** `n-able-n-central-auth-bypass-cve-2026-18577`
- **Must-know:** yes
...
- **Slug:** `inc-ransomware-sonicwall-sma1000`
- **Must-know:** no
...
- **Slug:** `chinese-actor-deepseek-ai-agent-attack`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `data-breach`
- **Slug:** `exfilsquad-pnld-uk-police-breach`
- **Must-know:** no
...
- **Slug:** `ghostblade-ios-darksword-exploit-kit`
- **Must-know:** no
...
- **Slug:** `midnight-blizzard-hotel-wifi-hacking`
- **Must-know:** no
...
- **Slug:** `iran-linked-water-system-attacks-us-states`
- **Must-know:** no
...
- **Slug:** `hugging-face-diffusers-rce-flaws`
- **Must-know:** no
...
- **Severity:** medium
- **Tags:** `malware`
- **Slug:** `btmob-android-rat-underground-business`
- **Must-know:** no
...
- **Slug:** `alibaba-qwen3-8-max-release`
- **Must-know:** no
...
- **Slug:** `thermo-fisher-dna-file-tampering-cve-2026-17583`
- **Must-know:** no
...
- **Slug:** `eu-ai-act-transparency-labeling-rules`
- **Must-know:** no
