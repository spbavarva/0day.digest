...
- **Slug:** `macos-screen-sharing-auth-bypass-monero-miner`
- **Must-know:** no
...
- **Slug:** `meta-releases-glimmer-open-weight-model`
- **Must-know:** no
...
- **Slug:** `sap-commerce-cloud-critical-rce-actively-exploited`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `data-breach`
- **Slug:** `france-dgfip-tax-authority-breach`
- **Must-know:** no
...
- **Slug:** `trivy-not-litellm-2500-org-compromise`
- **Must-know:** no
...
- **Slug:** `google-cloud-post-quantum-roadmap-2029`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `data-breach`
- **Slug:** `ringcentral-data-breach-1-6-million`
- **Must-know:** no
...
- **Slug:** `apple-china-ai-model-alibaba`
- **Must-know:** no
...
- **Slug:** `beacon-crm-breach-aws-key-leak-charities`
- **Must-know:** no
...
- **Slug:** `honeymyte-coolclient-kernel-rootkit`
- **Must-know:** no
...
- **Slug:** `geoserver-zero-day-sql-injection-rce`
- **Must-know:** yes
