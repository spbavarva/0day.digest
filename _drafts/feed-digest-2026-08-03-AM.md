...
- **Slug:** `passkey-mfa-bypass-attack-surface`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `microsoft`, `apt`
- **Slug:** `midnight-blizzard-wifi-gateway-credential-theft`
- **Must-know:** no
...
- **Slug:** `us-water-utility-cyberattacks-expand`
- **Must-know:** no
...
- **Slug:** `huggingface-diffusers-rce-flaws`
- **Must-know:** no
...
- **Slug:** `openai-teases-astra-model`
- **Must-know:** no
...
- **Slug:** `coldcard-wallet-rng-flaw-bitcoin-theft`
- **Must-know:** no
