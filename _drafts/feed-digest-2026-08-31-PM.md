...
- **Severity:** medium
- **Tags:** `vulnerability`
- **Slug:** `kaspersky-hardbreacher-exploit`
- **Must-know:** no
...
- **Slug:** `servicenow-critical-code-injection-vulns`
- **Must-know:** no
...
- **Tags:** `llm`, `openai`
- **Slug:** `chatgpt-eu-dsa-regulation`
- **Must-know:** no
...
- **Severity:** critical
- **Tags:** `data-breach`
- **Slug:** `mckesson-data-breach-shinyhunters`
- **Must-know:** yes
...
- **Severity:** medium
- **Tags:** `malware`
- **Slug:** `valleyrat-backdoor-signed-adware`
- **Must-know:** no
- **Summary:** The Silver Fox actor is distributing the ValleyRAT backdoor disguised as signed Chinese adware built around the QN Wallpaper tool, running under a trusted process to slip past AV exclusion lists. Kaspersky independently confirmed the same campaign.
...
- **Slug:** `anthropic-claude-infostealer-warning`
- **Must-know:** no
...
- **Slug:** `aurora-ransomware-cursor-ai`
- **Must-know:** no
...
- **Slug:** `securing-claude-code-compliance-api`
- **Must-know:** no
...
- **Severity:** critical
- **Tags:** `vulnerability`, `rce`
- **Slug:** `rails-kindarails2shell-rce`
- **Must-know:** no
...
- **Slug:** `spring-ring-teams-voice-phishing`
- **Must-know:** no
...
- **Severity:** informational
- **Tags:** `anthropic`
- **Slug:** `pentagon-anthropic-ruling-illegal`
- **Must-know:** no
...
- **Slug:** `fire-ant-cisco-router-hijack`
- **Must-know:** no
