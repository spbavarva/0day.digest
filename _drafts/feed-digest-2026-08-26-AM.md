...
- **Slug:** `gitea-rce-actively-exploited-cve-2026-60004`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `phishing`, `llm`
- **Slug:** `anonymouskit-ai-voice-phishing-apple-support`
- **Must-know:** no
...
- **Slug:** `npm-mirrors-abused-for-phishing-redirects`
- **Must-know:** no
...
- **Slug:** `hidden-prompts-trick-ai-email-summaries`
- **Must-know:** no
...
- **Slug:** `openclaw-ollama-llm-poisoning-flaw`
- **Must-know:** no
...
- **Slug:** `paylogix-akira-ransomware-breach`
- **Must-know:** no
...
- **Slug:** `claude-cowork-shared-memory`
- **Must-know:** no
