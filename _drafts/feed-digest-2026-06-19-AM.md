...
- **Slug:** `fortibleed-fortinet-credentials-leak-cisa-warning`
- **Must-know:** yes
...
- **Source:** The Hacker News — https://thehackernews.com/2026/06/salesforce-disables-klue-app.html (also SecurityWeek — https://www.securityweek.com/cybersecurity-firms-impacted-by-klue-supply-chain-attack/)
- **Section:** Cybersecurity — Primary
- **Severity:** critical
- **Tags:** `supply-chain`, `data-breach`
- **Slug:** `klue-supply-chain-attack-salesforce`
- **Must-know:** yes
...
- **Slug:** `splunk-enterprise-rce-actively-exploited`
- **Must-know:** no
...
- **Slug:** `gentlemen-ransomware-edr-killers`
- **Must-know:** no
...
- **Severity:** medium
- **Tags:** `malware`
- **Slug:** `socgholish-botnet-takedown`
- **Must-know:** no
...
- **Tags:** `appsec`, `llm`
- **Slug:** `datasette-apps-sandboxed-launch`
- **Must-know:** no
