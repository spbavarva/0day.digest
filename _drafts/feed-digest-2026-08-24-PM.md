...
- **Slug:** `google-cloud-ai-agent-security-governance`
- **Must-know:** no
...
- **Slug:** `reliaquest-failed-data-theft-shinyhunters`
- **Must-know:** no
...
### 3. WordlistLoader Delivers Amatera Stealer via ClickFix, SynkLoader Phishes Windows Passwords (2 sources merged)
...
- **Slug:** `wordlistloader-synkloader-malware`
- **Must-know:** no
...
- **Severity:** medium
- **Tags:** `malware`
- **Slug:** `toxicpanda-banking-trojan-enterprise`
- **Must-know:** no
...
- **Slug:** `south-korea-startup-platform-key-management-breach`
- **Must-know:** no
...
- **Severity:** medium
- **Tags:** `malware`
- **Slug:** `android-car-systems-proxy-botnet`
- **Must-know:** no
...
- **Slug:** `critical-keycloak-password-reset-flaw`
- **Must-know:** no
...
- **Severity:** medium
- **Tags:** `malware`
- **Slug:** `operation-quicsilver-myanmar-quicagent`
- **Must-know:** no
...
- **Severity:** informational
- **Tags:** `ai-safety`, `llm`
- **Slug:** `shadow-ai-power-users-security-risk`
- **Must-know:** no
...
- **Slug:** `cisa-zimbra-actively-exploited-flaw`
- **Must-know:** yes
...
- **Slug:** `iran-hackers-uk-power-plant-shutdown`
- **Must-know:** no
...
- **Slug:** `uat-10147-ai-server-attacks-spectre-rootkit`
- **Must-know:** no
