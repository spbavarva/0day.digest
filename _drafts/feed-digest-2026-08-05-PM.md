...
- **Slug:** `google-apk-for-python-agent-to-agent-attack`
- **Must-know:** no
...
- **Slug:** `poison-claude-discounted-access-prompt-snooping`
- **Must-know:** no
...
- **Slug:** `paperclip-ai-flaws-rce-malicious-agent-imports`
- **Must-know:** no
...
- **Slug:** `veeam-terraform-mcp-django-critical-flaws`
- **Must-know:** no
...
- **Tags:** `phishing`, `llm`
- **Slug:** `ai-powered-phishing-killed-blocklists`
- **Must-know:** no
...
- **Slug:** `npm-nullreceiver-blockchain-c2`
- **Must-know:** no
...
- **Slug:** `malware-hijack-passkey-protected-accounts`
- **Must-know:** no
...
- **Slug:** `ovswrap-linux-kernel-root-open-vswitch`
- **Must-know:** no
...
- **Slug:** `kali365-weaponizes-microsoft-authentication`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `data-breach`
- **Slug:** `brown-health-medical-group-data-breach`
- **Must-know:** no
...
- **Severity:** informational
- **Tags:** `ai-safety`, `llm`
- **Slug:** `safe-guidelines-ai-incident-data-sharing`
- **Must-know:** no
...
- **Slug:** `critical-gitea-unauthenticated-file-read`
- **Must-know:** no
...
- **Slug:** `aws-nitro-enclaves-kms-integration`
- **Must-know:** no
...
- **Slug:** `leaked-n8n-api-tokens-credential-theft`
- **Must-know:** no
...
- **Slug:** `open-vsx-evil-twin-extensions`
- **Must-know:** no
...
- **Slug:** `claude-mythos-5-backdoor-attempt`
- **Must-know:** no
...
- **Slug:** `cisa-langflow-tomcat-n-central-kev`
- **Must-know:** no
