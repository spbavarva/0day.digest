...
- **Slug:** `microsoft-entra-id-cvss-10-rce-exploited`
- **Must-know:** yes
...
- **Slug:** `rust-crates-supply-chain-attack-arrayref`
- **Must-know:** yes
...
- **Slug:** `trueconf-vulnerabilities-exploited-phantomcore`
- **Must-know:** no
...
- **Slug:** `russian-hackers-google-oauth-whatsapp-hijack`
- **Must-know:** no
...
- **Slug:** `silkparasite-china-espionage-ai-malware`
- **Must-know:** no
...
- **Slug:** `n-able-password-vault-master-keys`
- **Must-know:** no
...
- **Slug:** `custody-framework-ai-agent-security`
- **Must-know:** no
...
- **Slug:** `aws-network-firewall-rule-hit-count`
- **Must-know:** no
