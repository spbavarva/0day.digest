...
- **Slug:** `codex-agent-bug-deletes-home-directory`
- **Must-know:** no
...
- **Slug:** `nvidia-nemotron-3-embed-tops-rteb`
- **Must-know:** no
...
- **Slug:** `thinking-machines-lab-releases-inkling`
- **Must-know:** no
...
- **Slug:** `sandworm-fake-captcha-powershell-ukraine`
- **Must-know:** no
...
- **Severity:** informational
- **Tags:** `data-breach`
- **Slug:** `23andme-18-million-breach-settlement`
- **Must-know:** no
...
- **Slug:** `n8n-token-exchange-flaw-cross-issuer-takeover`
- **Must-know:** no
...
- **Severity:** informational
- **Tags:** `ai-launch`
- **Slug:** `apple-intelligence-approved-china-alibaba-baidu`
- **Must-know:** no
...
- **Slug:** `hellonet-vipnet-update-system-campaign`
- **Must-know:** no
...
- **Severity:** medium
- **Tags:** `malware`
- **Slug:** `telepuz-malware-clickfix-lures`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `malware`
- **Slug:** `clicklock-stealer-macos-password-loop`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `malware`
- **Slug:** `goserpent-backdoor-southeast-asia`
- **Must-know:** no
...
- **Slug:** `scattered-spider-tfl-sentencing`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `malware`, `appsec`
- **Slug:** `phantomenigma-brazilian-government-websites`
- **Must-know:** no
...
- **Slug:** `ai-agent-data-injection-attack`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `malware`
- **Slug:** `daxin-stupig-backdoor-taiwan`
- **Must-know:** no
...
- **Slug:** `cisa-oracle-ebs-actively-exploited-deadline`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `malware`
- **Slug:** `uat-11795-starland-rat-wldr-c2`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `ransomware`
- **Slug:** `spirals-ransomware-24-hour-encryption`
- **Must-know:** no
...
- **Slug:** `shark-vacuum-flaw-region-wide-takeover`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `vulnerability`, `cve`
- **Slug:** `f5-nginx-big-ip-vulnerabilities-patched`
- **Must-know:** no
...
- **Slug:** `openai-gpt-red-prompt-injection-red-teaming`
- **Must-know:** no
...
- **Slug:** `old-uefi-shims-secure-boot-bypass`
- **Must-know:** no
...
- **Severity:** critical
- **Tags:** `vulnerability`, `cve`
- **Slug:** `zoom-cve-2026-53412-account-takeover`
- **Must-know:** no
...
- **Slug:** `spain-cyber-fraud-ring-disrupted`
- **Must-know:** no
