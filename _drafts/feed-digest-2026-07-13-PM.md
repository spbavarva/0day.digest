...
- **Severity:** medium
- **Tags:** `malware`
- **Slug:** `crashstealer-macos-malware-notarized-dropper`
- **Must-know:** no
...
- **Slug:** `modheader-extension-pulled-hidden-collector`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `malware`
- **Slug:** `gigawiper-modular-destructive-implant`
- **Must-know:** no
...
- **Slug:** `google-k8s-aibom-ai-bill-of-materials`
- **Must-know:** no
...
- **Slug:** `cisa-github-leak-lessons-learned`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `phishing`, `llm`
- **Slug:** `forg365-phishing-as-a-service-microsoft-365`
- **Must-know:** no
...
- **Severity:** informational
- **Tags:** `phishing`, `llm`
- **Slug:** `scambuster-open-source-ai-scam-baiting-tool`
- **Must-know:** no
...
- **Slug:** `rabbitmq-oauth-secret-vulnerability`
- **Must-know:** no
...
- **Slug:** `cisa-router-hygiene-russian-state-targeting`
- **Must-know:** no
...
- **Severity:** medium
- **Tags:** `nation-state`
- **Slug:** `eu-uk-sanctions-russian-gru-hackers`
- **Must-know:** no
...
- **Severity:** medium
- **Tags:** `llm`, `malware`
- **Slug:** `ai-generated-powershell-active-directory-recon`
- **Must-know:** no
...
- **Slug:** `zimbra-critical-code-execution-vulnerability-patched`
- **Must-know:** no
...
- **Severity:** critical
- **Tags:** `data-breach`
- **Slug:** `centers-laboratory-data-breach-540000-individuals`
- **Must-know:** yes
...
- **Slug:** `icagenda-balbooa-joomla-zero-day-exploited`
- **Must-know:** yes
