...
- **Slug:** `papercut-second-emergency-patch-exploited-flaws`
- **Must-know:** yes
...
- **Slug:** `aws-management-console-private-access-data-perimeter`
- **Must-know:** no
...
- **Slug:** `givewp-wordpress-plugin-critical-rce`
- **Must-know:** no
...
- **Severity:** informational
- **Tags:** `google`, `appsec`
- **Slug:** `android-17-encrypted-client-hello-privacy`
- **Must-know:** no
...
- **Slug:** `owncloud-cve-2023-49105-kev-nuclear-research`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `malware`, `google`
- **Slug:** `chrome-edge-extensions-wallet-stealing-crypto-draining`
- **Must-know:** no
...
- **Slug:** `gitea-servers-vulnerable-code-execution`
- **Must-know:** no
...
- **Severity:** medium
- **Tags:** `anthropic`
- **Slug:** `anthropic-court-win-pentagon-supply-chain-risk-label`
- **Must-know:** no
...
- **Slug:** `openai-agents-linux-kernel-flaw-kev`
- **Must-know:** no
...
- **Slug:** `unitree-g1-humanoid-robot-root-rce-flaws`
- **Must-know:** no
...
- **Slug:** `servicenow-cvss-10-flaws-unauthenticated-rce-sqli`
- **Must-know:** no
...
- **Slug:** `openai-led-cyber-defense-pledge-130-companies`
- **Must-know:** no
...
- **Slug:** `zbt-routers-factory-implants-root-access`
- **Must-know:** yes
...
- **Severity:** medium
- **Tags:** `ai-safety`, `llm`
- **Slug:** `cisco-research-chinese-ai-model-lineage-risk`
- **Must-know:** no
...
- **Slug:** `cpanel-whm-critical-flaw-root-control`
- **Must-know:** no
...
- **Severity:** high
- **Tags:** `malware`, `apt`
- **Slug:** `apt28-hookedge-backdoor-european-government`
- **Must-know:** no
